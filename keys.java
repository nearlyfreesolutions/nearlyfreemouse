...
static String _esc = "ESC";
	...
	static String _tab = "Tab";
	static String _at = "at";
	static String _numbersign = "numbersign";
	static String _period = "period";
	static String _plus = "plus";
	static String _minus = "minus";
	static String _backslash = "backslash";
	static String _slash = "slash";
	static String _semicolon = "semicolon";
	static String _asterisk = "asterisk";
	static String _apostrophe = "apostrophe";
	static String _comma = "comma";
	static String _up = "Up";
	static String _down = "Down";
	static String _left = "Left";
	...
	static String _braceright = "braceright";
	static String _bracketleft = "bracketleft";
